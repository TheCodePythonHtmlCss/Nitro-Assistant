...
def wishMe():
    ...
    speak('I am Nitro Assistant. Please tell me how can I help you SIR?')


def sendEmail(to, content):
    server = smtplib.SMTP('tadkesparsh.gmail.com', 587)
    server.ehlo()
    server.starttls()
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'Nitro Assistant are you there' in query:
            ...
            if platform == "win32" or "darwin":
                speak('Sparsh is my master. He created me couple of days ago')
            elif platform == "linux" or platform == "linux2":
                name = getpass.getuser()
                speak(name, 'is my master. He is running me right now')

        elif 'your name' in query:
            speak('My name is Nitro Assistant')
        elif 'stands for' in query:
            speak('N.I.T.R.O stands for Never Irritateing assistant Trivo Rocking Over rocks')
            ...
            webbrowser.get('chrome').open_new_tab(
                'https://github.com/TheCodeRed727')
